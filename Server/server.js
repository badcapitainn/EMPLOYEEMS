...
app.post('/leaveapplication', (req, res) => {
    const sql = "INSERT INTO applyleave (`name`, `days`,`startdate`,`enddate`,`reason`,`status`) VALUES (?)";
    const values = [
        req.body.name,
        req.body.days, 
        req.body.startdate, 
...
app.get('/getleave', (req, res) => {
    const sql = "SELECT * FROM applyleave";
    con.query(sql, (err, result) => {
        if(err) return res.json({Error: "Get employee error in sql"});
        return res.json({Status: "Success", Result: result})
    })
...
app.put('/approveleave/:id', (req, res) => {
    const id = req.params.id;
...
app.put('/declineleave/:id', (req, res) => {
    const id = req.params.id;
    const sql = "UPDATE applyleave SET status = 'declined' WHERE id = ?";
    con.query(sql, [id], (err, result) => {
        if(err) return res.json({Error: "update status error in sql"});
        return res.json({Status: "Success"})
    })
...
app.post('/assigntasks', (req, res) => {
    const sql = "INSERT INTO tasks (`name`,`task`,`due`,`priority`,`status`) VALUES (?)";
    const values = [
        req.body.name, 
        req.body.task, 
        req.body.due, 
...
app.put('/approvetasks/:id', (req, res) => {
    const id = req.params.id;
...
app.get('/getleavedays', (req, res) => {
    const sql = "SELECT name, days, status FROM applyleave";
    con.query(sql, (err, result) => {
        if(err) return res.json({Error: "Get employee error in sql"});
        return res.json({Status: "Success", Result: result})
    })
